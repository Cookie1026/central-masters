...
# 確実に判明している修正のみ適用
# 0xf05e (^) は名前の区切りなので、文字として出力しない
mapping["CIDFont+F2_" + chr(0xf05e)] = ""
# 0xf065 (e) は「藤」
...
try:
        ...
        for page in pdf.pages:
            ...
            for c in page.chars:
                ...
                if key in mapping:
                    ...
                    c_copy['text'] = '' # Ignore unknown PUA
                modified_chars.append(c_copy)
                
            # x_tolerance=5 に戻す（文字の重複を防ぐため）
    ...
    print(f"Successfully generated Balanced V2: {csv_path}")
